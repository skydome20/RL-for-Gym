...
class DQN_Agent:
    ...
    def __init__(self, state_size, action_size):
        ...
        self.memory = deque(maxlen=2000) # remove old, update new
        self.gamma = 0.95
        self.epsilon = 1.0
...
if __name__ == '__main__' :
    ...
    for e in range(EPISODES):
        ...
        best_position = -1.2 # min position defined in 'MountainCar-v0'
...
#            
#            if position == 0.5: 
#                reward = 10                 # reach to the top (= 0.5)
#            else: 
#                #r1 = (-0.1) * steps         # more steps, more penalty
#                r2 = abs(position - (-0.5)) # more up, more reward;
#                reward = r2

            # record best position happened during steps
            best_position = position if (position > best_position) else best_position
            ...
            if done:
                position_his.append(best_position)
                print("episode: {}/{}, steps: {}, best_position: {:.4}"
                      .format(e, EPISODES, steps, best_position))
